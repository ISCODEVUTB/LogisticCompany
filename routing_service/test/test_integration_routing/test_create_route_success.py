...
async def test_create_route_success():
    ...
    with patch(
        "routing_service.app.api.routes.validate_driver",
        side_effect=mock_validate_driver,
    ) as mock_validate_driver, patch(
        "routing_service.app.api.routes.validate_orders",
        side_effect=mock_validate_orders,
    ), patch(
        "routing_service.app.api.routes.notify_driver_assignment",
        side_effect=mock_notify_driver_assignment,
    ), patch(
        "routing_service.app.api.routes.update_order_statuses",
        side_effect=mock_update_order_statuses,
    ):
