...
async def test_complete_route_update_fail():
    ...
    with patch("routing_service.app.api.routes.update_order_statuses", return_value=True), \
         patch("routing_service.app.api.routes.service.mark_as_completed", return_value=False): # Assuming 'service' is an instance within routes.py or accessible like this
