...
from app.schemas.shipping_order_schema import ShippingOrderCreateDTO
from app.services import shipping_order_service


@pytest.mark.asyncio
@patch("app.services.shipping_order_service.send_tracking_event", new_callable=AsyncMock)
