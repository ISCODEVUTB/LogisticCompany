...
async def test_get_tracking_history_success():
    with respx.mock() as mock:
        ...
        mock.post("https://test/api/events/track").mock(
            return_value=Response(status_code=200, json={"status": "success"})
        )

        # Mock para el GET
        mock.get("https://test/api/events/track/TRK654321").mock(
        ...
        async with httpx.AsyncClient(base_url="https://test") as client:
            ...
            response = await client.get("/api/events/track/TRK654321")
